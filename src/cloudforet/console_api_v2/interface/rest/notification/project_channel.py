...
class ProjectChannel(BaseAPI):
    ...
    async def create(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.create'
    ...
    async def update(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.update'
            return proxy_service.dispatch_api(params)
    ...
    async def set_schedule(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.set_schedule'
            return proxy_service.dispatch_api(params)
    ...
    async def set_subscription(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.set_subscription'
            return proxy_service.dispatch_api(params)
    ...
    async def enable(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.enable'
            return proxy_service.dispatch_api(params)
    ...
    async def disable(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.disable'
            return proxy_service.dispatch_api(params)
    ...
    async def delete(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.delete'
            return proxy_service.dispatch_api(params)
    ...
    async def get(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.get'
            return proxy_service.dispatch_api(params)
    ...
    async def list(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.list'
            return proxy_service.dispatch_api(params)
    ...
    async def stat(self, request: Request, body: dict = Body()):
        ...
        with self.locator.get_service(ProxyService, metadata) as proxy_service:
            params['grpc_method'] = 'notification.ProjectChannel.stat'
            return proxy_service.dispatch_api(params)
